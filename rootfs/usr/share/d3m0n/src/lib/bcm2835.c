...
int bcm2835_init(void)
{
    ...
    */
      ...
      if ((memfd = open("/dev/mem", O_RDWR | O_SYNC) ) < 0) 
	{
      ...
      bcm2835_peripherals = static_cast<uint32_t*>(mapmem("gpio", bcm2835_peripherals_size, memfd, (off_t)bcm2835_peripherals_base));
...
int bcm2835_close(void)
{
    ...
    bcm2835_peripherals = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_gpio = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_pwm  = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_clk  = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_pads = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_spi0 = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_bsc0 = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_bsc1 = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_st   = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_aux  = static_cast<uint32_t*>(MAP_FAILED);
    bcm2835_spi1 = static_cast<uint32_t*>(MAP_FAILED);
    return 1; /* Success */
}    

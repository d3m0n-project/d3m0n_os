    ...
    public:
        ...
        void draw() override
        {
            ...
            if(this->BackColor != Colors::White) {
                this->display1->drawRect(x1, y1, x2, y2, this->BackColor, true);
            }
            this->display1->drawText(this->Location.X, this->Location.Y, this->FontSize, this->text, this->Bold, this->ForeColor);
